...
class Results:
    """
    Read AutoDock Vina docking results and save the atoms (from the ligands)
    """
...
if __name__ == "__main__":
    ...
    size = [20, 20, 20]
    results_path = "/Users/mythanhthaonguyen/PycharmProjects/thesis_01/data/ZINC596.pdbqt"
